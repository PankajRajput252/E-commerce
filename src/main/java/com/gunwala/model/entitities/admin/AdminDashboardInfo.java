package com.gunwala.model.entitities.admin;
...
public class AdminDashboardInfo {
    ...
    public int getTotalInactiveUser() {
        return totalInactiveUser;
    }

    public void setTotalInactiveUser(int totalInactiveUser) {
        this.totalInactiveUser = totalInactiveUser;
    }

    public int getTotalNormalUser() {
        return totalNormalUser;
    }

    public void setTotalNormalUser(int totalNormalUser) {
        this.totalNormalUser = totalNormalUser;
    }

    public int getTotalAdminUser() {
        return totalAdminUser;
    }

    public void setTotalAdminUser(int totalAdminUser) {
